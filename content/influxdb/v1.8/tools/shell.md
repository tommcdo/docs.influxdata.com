...
* [`influx` options](/influxdb/v1.8/tools/shell/#influx-options)
...
> **Note:** If you get errors running `-import`, see [Common `-import` errors](/influxdb/v1.8/troubleshooting/errors/#common-import-errors).
